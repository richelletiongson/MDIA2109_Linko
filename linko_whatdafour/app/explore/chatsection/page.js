            ...
            <main className={styles.main}>
                ...
                <div className={styles.chatList}>
                    {chatList.map((chat, idx) => {
                        // Only Jennie Kim's chat is clickable
                        const isJennie = chat.name.startsWith("Jennie Kim");
                        return (
                            <div
                                ...
                                onClick={
                                    isJennie
                                        ? () => router.push("/explore/chat") // Change to your desired route
                                        : undefined
                                }
                                style={isJennie ? { cursor: "pointer" } : {}}>
                                <Image
                                    src={chat.avatar}
                                    alt={chat.name}
                                    width={72}
