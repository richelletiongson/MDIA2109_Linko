...
import styles from "./matched_mike.module.css";
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.text}>
        You connected<br />with <b>Mike!</b>
      </div>
      ...
      <div className={styles.inputRow}>
        <div style={{ position: 'relative', width: '350px' }}>
          <input
            type="text"
            placeholder="Type..."
            className={styles.inputFieldWithButton}
            style={{ width: '100%', paddingRight: '48px', height: '48px', borderRadius: '8px', border: '1px solid #ccc', fontSize: '16px', boxSizing: 'border-box' }}
          />
          <button
