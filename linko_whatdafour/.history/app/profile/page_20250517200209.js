...
import { NoteModal } from '@/app/.components/Modal/modal';
  ...
  return (
    <div className={styles.page}>
        ...
        <section className={styles.section}> 
          ...
          <Container text={note} color="noteBox" />
          <Button 
            buttonText="Edit" 
        ...
        <NoteModal isOpen={noteModalOpen} onClose={closeNoteModal} title="Edit Note">
