    ...
    <div className={styles.profileContainer}>
      ...
      <header className={styles.header}>
        <div className={styles.headerTop}>
          ...
          <span className={styles.statusIcons}> {/* status icons placeholder */} </span>
        </div>
        <div className={styles.logoRow}>
          <Image src="/logos/linko_logomark.svg" alt="Linko logo" width={100} height={40} className={styles.logo} />
