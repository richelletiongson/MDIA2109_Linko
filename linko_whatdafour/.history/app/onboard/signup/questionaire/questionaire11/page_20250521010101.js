...
export default function Questionaire11Page() {
    ...
    const handleCloseGetStarted = () => {
        ...
        router.push('/onboard/signup/load');
    };
    ...
    return (
        <div className={styles.page}>
            ...
            />
            {showGetStarted && (
                <div className={styles.bottomStartedModalOverlay}>
                    <div className={styles.bottomStartedModalBox}>
                        <h2 className={styles.modalTextBlack}>Welcome to Linko!</h2>
                        <p className={styles.modalTextBlack}>Your onboarding is complete. Get started now!</p>
                        <Button 
