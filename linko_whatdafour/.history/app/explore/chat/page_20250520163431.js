...
export default function ChatPage() {
  ...
  return (
    <div className={styles.page}>
      ...
      {/* Input Area */}
      <div style={{ position: 'fixed', bottom: 70, left: 0, right: 0, margin: '0 auto', maxWidth: 370, width: '100%', display: 'flex', alignItems: 'center', zIndex: 10 }}>
        <InputField
          value={inputValue}
          ...
          style={{ flex: 1 }}
        />
        <button className={styles.sendBtn} style={{ marginLeft: 8 }} >+</button>
      </div>
    </div>
  );
}
